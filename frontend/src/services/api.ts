...
export const ontologyApi = {
  ...
  updateLinkType: (id: string, data: unknown) => api.patch(`/ontology/link-types/${id}`, data),
  updateActionType: (id: string, data: unknown) => api.patch(`/ontology/action-types/${id}`, data),
  updateProperty: (propId: string, data: unknown) => api.patch(`/ontology/properties/${propId}`, data),
  ...
  generateOntology: (description: string, provider_id?: string) => api.post('/ontology/generate', { description, provider_id }),
  applyOntologyPlan: (plan: unknown) => api.post('/ontology/apply-plan', { plan }),
  listFunctions: () => api.get('/ontology/functions'),
  createFunction: (data: unknown) => api.post('/ontology/functions', data),
  getFunction: (id: string) => api.get(`/ontology/functions/${id}`),
  updateFunction: (id: string, data: unknown) => api.patch(`/ontology/functions/${id}`, data),
  deleteFunction: (id: string) => api.delete(`/ontology/functions/${id}`),
  executeFunction: (id: string, inputs: Record<string, unknown>) => api.post(`/ontology/functions/${id}/execute`, { inputs }),
};
...
export const aipApi = {
  ...
  updateProvider: (id: string, data: unknown) => api.patch(`/aip/providers/${id}`, data),
  ...
  updateFunction: (id: string, data: unknown) => api.patch(`/aip/functions/${id}`, data),
  deleteFunction: (id: string) => api.delete(`/aip/functions/${id}`),
